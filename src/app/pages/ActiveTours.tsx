...
export function ActiveTours() {
  ...
  // Guide xem trong dashboard
  if (isGuide) return <Navigate to="/guide" state={{ tab: 'active' }} replace />

  return <CustomerActiveTours />
}

function CustomerActiveTours() {
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container mx-auto max-w-5xl px-4 py-6">
        ...
        <nav className="mb-4 flex items-center gap-1.5 text-xs text-slate-500">
          ...
          <span className="font-medium text-slate-900">Tour đang diễn ra</span>
        </nav>

        {/* Live hero header */}
        <div className="mb-6 overflow-hidden rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-orange-50 p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <h1 className="text-base font-semibold text-slate-900 md:text-lg">Tour đang diễn ra</h1>
                <p className="mt-1 text-sm text-slate-600">
                  Theo dõi tour bạn đã đặt, nhắn tin với hướng dẫn viên và xem lộ trình GPS thời gian thực.
                </p>
              </div>
            </div>
...
function CustomerEmptyState() {
  return (
    <div className="rounded-xl border border-dashed border-slate-200 bg-white p-10 text-center">
      ...
      <p className="text-sm font-semibold text-slate-900">Bạn chưa có tour nào đang diễn ra</p>
      <p className="mx-auto mt-1 max-w-md text-xs text-slate-500">
        Tour bạn đã đặt sẽ tự động xuất hiện ở đây vào ngày khởi hành. Khám phá thêm tour mới để bắt đầu hành trình tiếp theo.
      </p>
      <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
        ...
        <Button size="sm" variant="outline" asChild>
          <Link to="/my-bookings">Xem đơn đã đặt</Link>
        </Button>
      </div>
    </div>
  )
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                className={cn(
                  ...
                  booking.hasActiveTracking && 'bg-emerald-600 hover:bg-emerald-700',
                )}
              >
