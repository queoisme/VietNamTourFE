...
import { getNotifPath, getNotifVisual, relativeTime } from './NotificationBell'
...
export interface NotificationsPanelProps {
  /** Tailwind class for sticky offset of the toolbar (e.g. "top-16"). Omit to disable sticky. */
  stickyTop?: string
  /** Outer card class for the wrapper. */
  className?: string
}

export function NotificationsPanel({ stickyTop, className }: NotificationsPanelProps) {
  ...
  return (
    <div className={cn('rounded-3xl bg-white shadow-xl shadow-slate-900/5', className)}>
      {/* Toolbar */}
      <div className={cn(
        'flex flex-wrap items-center justify-between gap-3 rounded-t-3xl border-b border-slate-100 bg-white px-5 py-4',
      ...
      {/* Pagination */}
      {totalPages > 1 && (
        <div className="flex items-center justify-between gap-3 rounded-b-3xl border-t border-slate-100 px-5 py-4">
